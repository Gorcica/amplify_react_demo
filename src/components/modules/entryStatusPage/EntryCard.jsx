...
import EntryProductCaption from '../../atoms/EntryProductCaption';
...
const EntryCard = (props) => {
  console.log(props);
  return (
    <Box sx={{ display: "flex", flexDirection:"column", justifyContent:"start", alignItems:"center", borderRadius: 2, pl: 1, pr: 1, pt: 2, border: 1, mr: 2 , mb: 2, width: '300px', minHeight: 560, textAlign: 'center' }}>
        <ProductImage {...props}/>
        <WideSpacer />
        <EntryProductCaption {...props}/>
    </Box>
  );}
